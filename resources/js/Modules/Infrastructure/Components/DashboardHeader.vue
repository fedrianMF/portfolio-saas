            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-slate-950" fill="none"
                ...
                <div class="flex gap-3 md:gap-6 items-center">
                    ...
                    <div class="flex items-center gap-2 md:gap-3">
                        ...
                        <button
                            ...
                            <span
                                class="absolute top-2 right-2 h-2 w-2 bg-indigo-500 rounded-full border border-slate-900"></span>
                        </button>

                        <!-- User Dropdown -->
                        <Dropdown align="right" width="48"
                            content-classes="py-1 bg-slate-800 border border-slate-700 shadow-2xl">
                            <template #trigger>
                                <button
                            ...
                            <template #content>
                                <div class="px-4 py-3 border-b border-slate-700/50">
                                    <p class="text-[10px] text-slate-500 uppercase tracking-widest font-black mb-1">
                                        Authenticated as</p>
                                    <p class="text-sm text-slate-200 truncate font-medium">{{
