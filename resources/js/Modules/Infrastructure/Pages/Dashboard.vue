...
const { model, os, uptime, cpu, cpu_load, ram, mounts, network, php_version } = props.dash;
    ...
    <div class="min-h-screen bg-slate-950 text-slate-50">
        ...
        <main class="p-6 space-y-8">
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold text-slate-50">System Monitor</h2>
                <ServerStats v-if="props.dash" :data="props.dash" />
            </section>
