...
import HealthOverview from './Partials/HealthOverview.vue'
import SecurityOverview from './Partials/SecurityOverview.vue'
import ResourceChart from './Partials/ResourceChart.vue'
import DatabasePerformance from './Partials/DatabasePerformance.vue'
import WorkerMonitor from './Partials/WorkerMonitor.vue'
import JobPipeline from './Partials/JobPipeline.vue'
import CronScheduler from './Partials/CronScheduler.vue'
import ActiveSessions from './Partials/ActiveSessions.vue'
import DockerContainers from './Partials/DockerContainers.vue'
import AuditLogs from './Partials/AuditLogs.vue'
