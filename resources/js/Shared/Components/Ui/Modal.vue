    ...
    <dialog class="z-50 m-0 min-h-full min-w-full overflow-y-auto bg-transparent backdrop:bg-transparent" ref="dialog">
        <div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" scroll-region>
            ...
            <Transition enter-active-class="ease-out duration-300"
                ...
                <div v-show="show"
                    class="mb-6 transform overflow-hidden rounded-3xl bg-slate-900/95 border border-slate-800 backdrop-blur-2xl shadow-2xl transition-all sm:mx-auto sm:w-full"
                    :class="maxWidthClass">
                    <slot v-if="showSlot" />
                </div>
            </Transition>
